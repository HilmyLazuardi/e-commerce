...
Route::group(['namespace' => 'Web'], function () {
    ...
    Route::group(['middleware' => 'coming.soon'], function () {
        ...
        Route::group(['middleware' => 'auth.user'], function () {
            ...
            Route::get('/order/tracking-log', 'OrderController@order_tracking_log')->name('web.order.tracking.log');
            ...
            Route::post('/order/update-status', 'OrderController@update_status')->name('web.order.update_status');
            Route::post('/order/refund', 'OrderController@submit_refund')->name('web.order.refund');
            ...
            // REFUND LIST
            Route::get('/order-refund', 'OrderController@refund_page')->name('web.order.refund');
            Route::post('/order-refund-data', 'OrderController@refund_data')->name('web.order.refund_data');
            Route::get('/order-refund-create', 'OrderController@refund_order_create')->name('web.order.refund_create');
            Route::post('/order-refund-store', 'OrderController@refund_order_store')->name('web.order.refund_store');
        });
    ...
    if (env('ADMIN_CMS', false) == true) {
        ...
        Route::group(['middleware' => 'auth.admin'], function () {
            ...
            Route::group(['prefix' => 'order'], function () {
                ...
                Route::match(['get', 'post'], '/request-pickup', 'OrderController@request_pickup')->name('admin.order.request_pickup');

                // SENT WABLAS TO BUYER
                Route::get('/send-wa/{id}', 'OrderController@send_wa')->name('admin.order.send_wa');

                Route::get('/admin/order/print/{id}', 'OrderController@print_invoice')->name('admin.order.print_invoice');
            });
            ...
            Route::group(['prefix' => 'order-summary'], function () {
                Route::get('/', 'OrderSummaryController@index')->name('admin.order_summary');
                Route::get('/get-data', 'OrderSummaryController@get_data')->name('admin.order_summary.get_data');
                Route::get('/export', 'OrderSummaryController@export')->name('admin.order_summary.export');
                // Route::get('/print-pesanan-terlaris', 'OrderSummaryController@print_pesanan_terlaris')->name('admin.order_summary.print');
                Route::get('/print-pesanan-terlaris', 'OrderSummaryController@print_pesanan_terlaris')->name('admin.order_summary.preview_pdf');
            });
            
            Route::prefix('product-stock-recap')->group(function() {
                Route::get('', 'ProductStockRecapController@index')->name('admin.stock_recap');
                Route::get('/get-data', 'ProductStockRecapController@get_data')->name('admin.stock_recap.get_data');
                Route::get('/export', 'ProductStockRecapController@export')->name('admin.stock_recap.export');
                Route::get('/preview-pdf', 'ProductStockRecapController@preview_pdf')->name('admin.stock_recap.preview_pdf');
            });

            Route::group(['prefix' => 'refund-order'], function () {
                Route::get('/', 'RefundOrderController@index')->name('admin.refund_order');
                Route::get('/get-data', 'RefundOrderController@get_data')->name('admin.refund_order.get_data');
                Route::get('/detail/{id}', 'RefundOrderController@detail')->name('admin.refund_order.detail');
            });

            Route::group(['prefix' => 'order-invoice'], function () {
                Route::get('/', 'OrderInvoiceController@index')->name('admin.order_invoice');
                Route::get('/get-data', 'OrderInvoiceController@get_data')->name('admin.order_invoice.get_data');
                Route::get('/print-preview-pdf', 'OrderInvoiceController@preview_pdf')->name('admin.order_invoice.preview_pdf');
            });

            Route::group(['prefix' => 'order-report'], function () {
                Route::get('/', 'OrderReportController@index')->name('admin.order_report');
                Route::get('/get-data', 'OrderReportController@get_data')->name('admin.order_report.get_data');
                Route::get('/print-preview-pdf', 'OrderReportController@preview_pdf')->name('admin.order_report.preview_pdf');
            });
        });
    }
});
...
Route::group(['prefix' => 'helper'], function () {
    ...
    Route::post('/filter-sku-variant', 'HelperController@filter_sku_variant')->name('helper.filter_sku_variant');
});
