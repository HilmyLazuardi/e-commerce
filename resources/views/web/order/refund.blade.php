            ...
            <div class="section_history">
                <div class="container">
                    ...
                    <div class="button_wrapper">
                        <a href="{{ route('web.order.refund_create') }}" class="red_btn">Ajukan Refund</a>
                    </div>
                </div>
            </div>
        </div>
...
@section('footer-script')
    <script>
        ...
        function refresh_data() {
            ...
            $.ajax({
                type: "POST",
                // url: "{{ route('web.order.refund_data') }}?keyword=" + keyword + '&filter=' + filter,
                url: "{{ route('web.order.refund_data') }}?keyword=" + keyword,
                data: {
                    _token : '{{ csrf_token() }}',
                    buyer_id : '{{ $buyer_id }}'
                },
