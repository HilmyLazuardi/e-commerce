...
<body>
	<div class="wrapper">
		<section id="full_height">
			<div class="pos_abs" style="max-width: 640px;padding: 0 20px;">
				<img src="{{ asset('web/images/logo_full.png') }}" style="margin: 0 auto 20px;width: 100%;max-width: 420px;">
				<span style="font-size: 20px;font-family: 'WorkSans';line-height: 40px;">Something "OUT OF THE BOX" is currently in progress...<br>We'll be back soon, please stay tuned!</span>
			</div>
		</section>
	</div>
</body>
