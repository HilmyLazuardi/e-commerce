                                    ...
                                    <select class="select2 delivery_method" name="delivery_method[{{ $seller_id }}]" id="delivery_method_{{ $seller_number }}" onchange="generate_delivery_fee({{ $seller_number }})" required>
                                        ...
                                        @if (!is_null($shipment))
                                            @foreach ($shipment as $v_shipment)
                                                ...
                                                @php $shipment_label = $v_shipment->name . ' - Rp' . number_format($v_shipment->cost,0,",",".") . ' (' . $v_shipment->etd_thru . ' Hari)'; @endphp
                                                ...
                                                <option value="{{ $v_shipment->code .' '. $v_shipment->service }}" data-service-type="{{ $v_shipment->name }}" data-price="{{ $v_shipment->cost }}" data-estimate="{{ $v_shipment->etd_last }}">{{ $shipment_label }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                        ...
                        if (response.status == true) {
                            ...
                            if (response.data != null) {
                                ...
                                $.each(response.data.data, function(key, value) {
                                    ...
                                    var text        = value.name + ' - Rp' + number_formatting(value.cost.toString(), '.') + ' (' + value.etd_thru + ' Hari)';
                                    ...
                                    newOption       = '<option value="' + value.code+' '+ value.service + '" data-service-type="' + value.name + '" data-price="' + value.cost + '" data-estimate="' + estimate + '">' + text + '</option>';
