		...
		<tbody style="background: #cfefff;border-radius: 10px;">
			<tr>
				<td style="color:#3A3A3A;background:#cfefff;font-family: Arial, Helvetica, sans-serif;padding:20px 40px 20px 40px;text-align: center;border-top: 1px solid #66b9e8;">
					Halo <strong>{!! $data['name'] !!}</strong>,<br><br>Password kamu sudah diganti yang baru.<br><br>Tidak merasa mengubahnya? Segera reset password kamu dengan klik "Lupa Password" saat akan login dan hubungi kami di <a style="color:#4fa8d8;" href="mailto:help@larizzkajaya.com">help@larizzkajaya.com.</a>
				</td>
			</tr>
		</tbody>
		<tfoot>
