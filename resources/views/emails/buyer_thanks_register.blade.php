		...
		<tbody style="background: #cfefff;border-radius: 10px;">
			...
			<tr>
				<td style="padding:0 40px 20px 40px;color:#3A3A3A !important;text-align: center;">
					...
					<a href="{!! route('web.home') !!}" style="background: #4fa8d8;color:#FFF;padding:10px 20px;text-decoration: none;min-width: 200px;display: inline-block;">Belanja Sekarang</a>
				</td>
			</tr>
		</tbody>
		<tfoot>
