				...
				<td colspan="2" style="padding:20px;">
					<table style="width: 400px;background:#F0F0F0;border-radius: 10px;padding:20px;margin:0 auto 20px;">
						<tr>
							...
							<td style="padding-bottom:10px;color:#24536d;font-size:14px;text-align: left;"><strong style="color:#D70002;">{!! $data['total_price'] !!}</strong></td>
						</tr>
						<tr>
							<td style="padding-bottom:10px;color:#24536d;font-size:14px;text-align: left;">Tanggal batas bayar:</td>
							<td style="padding-bottom:10px;color:#24536d;font-size:14px;text-align: left;"><strong>{!! $data['expired_date'] !!}</strong></td>
						</tr>
						<tr>
							<td style="padding-bottom:10px;color:#24536d;font-size:14px;text-align: left;">Waktu batas bayar:</td>
							<td style="padding-bottom:10px;color:#24536d;font-size:14px;text-align: left;"><strong>{!! $data['expired_time'] !!} WIB</strong></td>
						</tr>
					</table>
					<table style="width: 400px;margin:0 auto 20px;">
                        <tr>
							<td colspan="2"><a href="{!! $data['link'] !!}" style="width:160px;color:#fff;font-size:14px;font-weight:bold;border:1px solid #4fa8d8;background:#4fa8d8;text-align: center;line-height: 36px;margin:0 auto;display: block;text-decoration: none;border-radius: 5px;">Bayar Sekarang</a></td>
						</tr>
					</table>
