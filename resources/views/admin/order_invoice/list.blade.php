...
@php
    $module             = ucwords(lang('Rekap invoice', $translations));
    $pagetitle          = $module;
    ...
    <script>
        ...
        function refresh_data() {
            ...
            var table = $('#datatables').DataTable({
                ...
                serverSide: false,
                processing: true,
                ajax: "{{ route('admin.order_invoice.get_data') }}?&daterange="+daterange+"&status="+status,
                order: [[ 0, 'desc' ]],
                columns: [
        ...
        function updateExportPDF() {
            ...
            var url = "{{ route('admin.order_invoice.preview_pdf') }}?daterange=" + encodeURIComponent(daterange) + "&status=" + encodeURIComponent(status);
