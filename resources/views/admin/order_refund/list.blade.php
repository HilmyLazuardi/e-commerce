...
@php
    $module             = ucwords(lang('refund pesanan', $translations));
    $pagetitle          = $module;
                            ...
                            <table id="datatables" class="table table-striped table-bordered" style="display:none">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ ucwords(lang('foto refund')) }}</th>
    ...
    <script>
        ...
        function refresh_data() {
            ...
            var table = $('#datatables').DataTable({
                ...
                serverSide: false,
                processing: true,
                ajax: "{{ route('admin.refund_order.get_data') }}?&daterange="+daterange+"&status="+status,
                order: [[ 0, 'desc' ]],
                columns: [
                    { data: 'created_at', name: 'order_refund.created_at' },
                    ...
                    { data: 'refund_photo', name: 'order_refund.refund_photo' },
